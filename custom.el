(custom-set-variables
 ...
 '(package-selected-packages
   '(dash fanyi denote esup vterm cdlatex auctex youdao-dictionary flyspell-correct-ivy dante haskell-mode j-mode cargo flycheck-rust rust-mode yarn-mode prettier-js add-node-modules-path tide typescript-mode counsel-css pollen-mode scribble-mode racket-mode lsp-ui company-restclient restclient counsel-tramp json-mode yaml-mode dockerfile-mode lsp-pyright csproj-mode csharp-mode idris-mode elm-mode eldoc-box treemacs-projectile treemacs-magit treemacs eshell-prompt-extras esh-autosuggest eyebrowse dashboard deft markdown-mode ox-gfm ox-pandoc ibuffer-projectile projectile git-modes git-link git-messenger git-timemachine diff-hl magit-todos magit flycheck company dired-git-info dired-subtree diredfl dired-filter all-the-icons-ivy-rich ivy-rich ivy-hydra flx counsel ivy kaolin-themes doom-themes doom-modeline goto-line-preview hl-todo dr-racket-like-unicode undo-tree rainbow-delimiters paredit smartparens editorconfig paradox link-hint which-key all-the-icons-ibuffer exec-path-from-shell use-package))
